...
<head>
	...
	<meta content="https://7un90raqlu.preview-beefreedesign.com/zPwU" property="og:url" />
	<meta content="https://pro-bee-beepro-thumbnail.getbee.io/messages/1323011/1309301/2321443/12155513_large.jpg" property="og:image" />
		...
		<div class="bee-row bee-row-1">
			<div class="bee-row-content">
				<div class="bee-col bee-col-1 bee-col-w12">
					<div class="bee-block bee-block-1 bee-image"><img alt="" class="bee-center bee-autowidth" src="https://8e8ed06fca.imgdist.com/pub/bfra/ttvesvfv/qx5/4le/fya/logo_van.png" style="max-width:278px;" /></div>
					<div class="bee-block bee-block-2 bee-heading">
						<h1><span class="tinyMce-placeholder">{{name}} Activate your account</span> </h1>
					</div>
					<div class="bee-block bee-block-3 bee-button"><a class="bee-button-content" href="{{url}}" style="font-size: 16px; display: inline-block;" target="_blank"><span style="word-break: break-word; font-size: 16px; line-height: 200%; letter-spacing: normal;">Activate link</span></a></div>
				</div>
			</div>
		</div>
